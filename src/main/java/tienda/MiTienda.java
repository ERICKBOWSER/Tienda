...
public class MiTienda {
    public static void main(String[] args) {
        ...
        Comparator<Producto> precioOrden = (p1, p2) -> Double.compare(p1.getPrecio(), p2.getPrecio());
        Collections.sort(productos, precioOrden); // Lista, comparador
        ...
        //Comparator<Producto> codigoOrden = (p1, p2) -> p1.getCodigo().compareTo(p2.getCodigo());
